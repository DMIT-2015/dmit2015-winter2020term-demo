...
public class LogoutServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Cookie usernameCookie = new Cookie("LoggedInUsername", null);
		usernameCookie.setMaxAge(0);			// delete this cookie
		response.addCookie(usernameCookie);	

		Cookie bearAuthCookie = new Cookie("BearAuth", null);
		bearAuthCookie.setMaxAge(0);			// delete this cookie
		response.addCookie(bearAuthCookie);	
